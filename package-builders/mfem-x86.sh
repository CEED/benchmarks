...
# Clone MFEM and build the parallel version using the x86 branch.
...
pkg_src_dir="mfem-x86"
MFEM_SOURCE_DIR="$pkg_sources_dir/$pkg_src_dir"
pkg_bld_dir="$OUT_DIR/mfem-x86"
MFEM_DIR="$pkg_bld_dir"
pkg_var_prefix="mfem_x86_"
pkg="MFEM (x86)"


function mfem_x86_clone()
{
...
{
   mfem_x86_clone && get_package_git_version && mfem_x86_build
}
