...
out.write('''\
    | quad | asse | std |  comp  |     | number of | assembly dps | cg-iter dps | qpts per
  p |  pts | mbly | hpc |  iler  |  np |  unknowns |   millions   |   millions  |  unknown
----+------+------+-----+--------+-----+-----------+--------------+-------------+---------
''')
line_fmt=' %2i | %4i |  %2s  | %s | %6s | %3i | %9i | %11.6f  | %11.6f | %7.4f\n'
for run in set1:
