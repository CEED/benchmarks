...
// Comment/uncomment to disable/enable the use of add_mult_mass_2d():
   ...
   for (i = 0; i < nelem; i++)
   {
      ...
      for (k1 = 0; k1 < n; k1++)
      {
         for (k2 = 0; k2 < m; k2++)
         {
            ...
            for (k3 = 0; k3 < n; k3++)
            {
               t[k1*m+k2] += B1d[k2+m*k3] * x_loc[k3+n*k1];
            }
         }
      }
      ...
      for (k1 = 0; k1 < m; k1++)
      {
         for (k2 = 0; k2 < m; k2++)
         {
            ...
            for (k3 = 0; k3 < n; k3++)
            {
               x_qpt[k1*m+k2] += t[k2+m*k3] * B1d[k1+m*k3];
            }
         }
      }
      ...
      for (k1 = 0; k1 < n; k1++)
      {
         for (k2 = 0; k2 < m; k2++)
         {
            ...
            for (k3 = 0; k3 < m; k3++)
            {
               t[k1*m+k2] += x_qpt[k2+n*k3] * B1d[k3+m*k1];
            }
         }
      }
      ...
      for (k1 = 0; k1 < n; k1++)
      {
         for (k2 = 0; k2 < n; k2++)
         {
            ...
            for (k3 = 0; k3 < m; k3++)
            {
               x_loc[k1*n+k2] += B1d[k3+m*k2] * t[k3+m*k1];
            }
         }
      }
      ...
      for (j = 0; j < ndofs; j++)
      {
         y[dof_offsets[i*ndofs+j]] += x_loc[j];
      }
   }
}
